...
public class MariaDbTest : IAsyncLifetime
{
    private readonly Mariadb _database = new();
    ...
    {
        Assert.IsType<Mariadb>(await _database.Connect(_container.GetConnectionString()));
    }
